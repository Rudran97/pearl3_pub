...
package pearl3_soc_pkg is
    ...
    constant cv_dbg_cfg_TRIG3      : std_logic_vector(7 downto 0) := X"C3";
    constant cv_dbg_cfg_TRIG4      : std_logic_vector(7 downto 0) := X"C4";
    constant cv_dbg_cfg_TRIG5      : std_logic_vector(7 downto 0) := X"C5";
    constant cv_dbg_cfg_TRIG6      : std_logic_vector(7 downto 0) := X"C6";
    constant cv_dbg_cfg_TRIG7      : std_logic_vector(7 downto 0) := X"C7";
    ...
    constant cv_DBG_TSELECT_TRIG2  : std_logic_vector(31 downto 0) := X"0000_0002";
    constant cv_DBG_TSELECT_TRIG3  : std_logic_vector(31 downto 0) := X"0000_0003";
    constant cv_DBG_TSELECT_TRIG4  : std_logic_vector(31 downto 0) := X"0000_0004";
    constant cv_DBG_TSELECT_TRIG5  : std_logic_vector(31 downto 0) := X"0000_0005";
    constant cv_DBG_TSELECT_TRIG6  : std_logic_vector(31 downto 0) := X"0000_0006";
    constant cv_DBG_TSELECT_TRIG7  : std_logic_vector(31 downto 0) := X"0000_0007";
